...
values ('테스트글제목1',
       ...
       ('테스트글제목2',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 10000, 2),
       ('테스트글제목3',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 70000, 2),
       ('테스트글제목4',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 100, 1),
       ('테스트글제목5',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 20, 2),
       ('테스트글제목6',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 200, 1),
       ('테스트글제목7',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 70, 2),
       ('테스트글제목8',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 1, 1),
       ('테스트글제목9',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 201, 2),
       ('테스트글제목10',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'PUBLIC', 500, '2024-03-19 00:00:00', 2024, 1);
# 비밀글 추가
INSERT INTO tbl_post
(post_title, post_text, post_status, post_price, post_wri_date, post_view, po_member_code)
values ('테스트글제목11',
...
values ('테스트글제목21',
       ...
       ('테스트글제목22',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'DRAFT', 500, '2024-03-19 00:00:00', 10000, 2),
       ('테스트글제목23',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'DRAFT', 500, '2024-03-19 00:00:00', 70000, 2),
       ('테스트글제목24',
        '테스트용 포스트입니다. 이 글은 영국에서부터 시작되서 100년동안 어쩌구 저쩌구',
        'DRAFT', 500, '2024-03-19 00:00:00', 100, 1),
       ('테스트글제목25',
        '테스트용 포스트입니다. 이 글은 영국에서s부터 시작되서 100년동안 어쩌구 저쩌구',
        'DRAFT',500,'2024-03-19 00:00:00', 100, 1);
